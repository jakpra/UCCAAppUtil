...
try:
    ...
    print("(Randomly) sample sentences from STREUSLE corpus, w.r.t. either type balance (as many different preposition types as possible), or unit density (as many prepositions as possible; add flag 'many' to arguments). The CORPUS file has to have PSS unit identification as generated by identify.py from the streusle github repo.", file=sys.stderr)
